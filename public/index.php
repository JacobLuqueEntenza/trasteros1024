...
<section class="principal">
    ...
    <h3 id="parrafo">Simplifica tu almacenamiento y mantén tus pertenencias seguras con nuestros trasteros en alquiler.
    </h3>
    <div class="botones">
        <button
            onclick="window.location.href='/trasteros1024/app/vista/trasteros/trasteros.php#situacionTrasteros' ">Explorar
            Trasteros</button>
    </div>
</section>
<section class="catalogo">
    ...
    <div class="contenedorTarjetas">
        <div class="tarjeta">
            ...
            <p>Desde pequeños hasta extra grandes, tenemos una variedad de trasteros para cubrir todas tus necesidades
                de almacenamiento.</p>
        </div>
        <div class="tarjeta">
