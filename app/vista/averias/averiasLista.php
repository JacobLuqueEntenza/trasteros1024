...
<div class="containertext-center mb-5 ">
    ...
    <div class="col-md-12">    
        <div class="container mt-5 ">
            <button type="button" class="btn btn-success mb-3 btn-lg" onclick="window.location.href='averiaNuevo.php'">Añadir Averia</button>
                            ...
                            <table class="table text-center tablaUsuarios" id="tablaUsuarios">
                                ...
                                <?php foreach($todasAverias as $averia){ ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a href='averiaEditar.php?id=<?php echo $averia['id_averia'];?>'><img class="ediborra" src="/trasteros1024/public/multimedia/img/editar.ico" alt="Editar"></a>
                                        </td>
                                        <td>
                                            <a href='averiaEditar.php?id=<?php echo $averia['id_averia'];?>'><img class="ediborra" src="/trasteros1024/public/multimedia/img/borrar.ico" alt="Eliminar"></a>
                                        </td>
                                    </tr>
                                    <?php } ?>
                                </tbody>
