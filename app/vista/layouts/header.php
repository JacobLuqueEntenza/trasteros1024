    ...
    <header class="header" id="header">
        <nav class="navbar">
            ...
            <label for="menu" class="lblHamburguesa">
                <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="currentColor" class="hamburguesa"
                    viewBox="0 0 16 16">
            ...
            <ul class="ulMenu">
                ...
                if (isset($_SESSION['usuario']) && isset($_SESSION['rol']) && $_SESSION['rol'] != 3) { ?>
                    ...
                    <li class="liMenu"><a class="aMenu" href="/trasteros1024/app/vista/recibos/recibosLista.php">Recibos</a>
                    </li>
                <?php }
                if (isset($_SESSION['usuario']) && isset($_SESSION['rol']) && $_SESSION['rol'] == 1) { ?>
                    <li class="liMenu"><a class="aMenu" href="/trasteros1024/app/vista/usuarios/usuariosLista.php"
                            onclick="borrarCliente();">Usuarios</a> </li>
                <?php } ?>
                ...
                if (!isset($_SESSION['usuario'])) { ?>
                    ...
                    <li class="liMenu"><a class="aMenu" href="/trasteros1024/app/vista/usuarios/usuarioEditar.php">Hola,
                            <?php echo $_SESSION['usuario']; ?> </a></li>
                    <li class="liMenu"><a class="aMenu"
                            href="/trasteros1024/app/controlador/cerrarSesionControlador.php">CerrarSesión</a></li>
                    <?php
                }
                ;
                ?>
