...
<div class="container mt-5">
    ...
    <form class="mx-auto" style="max-width: 600px;" action="../../controlador/correoContactos.php" method="POST">
        <div class="mb-3">
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" id="asunto" name="asunto" placeholder="¿De qué se trata tu consulta?" required>
        </div>
        <div class="mb-3">
